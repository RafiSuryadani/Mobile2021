package umn.ac.id.week07b_32986;
...
public class DaftarVideoAdapter extends RecyclerView.Adapter<umn.ac.id.week07b_32986.DaftarVideoAdapter.ItemVideoViewHolder> {
    ...
    class ItemVideoViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        private umn.ac.id.week07b_32986.DaftarVideoAdapter mAdapter;
        private int mPosisi;
        private SumberVideo mSumberVideo;
        public ItemVideoViewHolder(@NonNull View itemView, umn.ac.id.week07b_32986.DaftarVideoAdapter adapter) {
            super(itemView);
            mAdapter = adapter;
